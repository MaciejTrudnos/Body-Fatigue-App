...
@Entity
data class OrthostaticTest(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "Id") val id: Int = 0,
    @ColumnInfo(name = "BPM") val bpm: Int,
    @ColumnInfo(name = "IBI") val ibi: Int,
    @ColumnInfo(name = "Position") val position: PositionTest,
    @ColumnInfo(name = "CreateDate") val createDate: LocalDateTime,
){
    constructor(bpm: Int, ibi: Int, position: PositionTest, createDate: LocalDateTime)
            : this(0, bpm, ibi, position, createDate)
}
